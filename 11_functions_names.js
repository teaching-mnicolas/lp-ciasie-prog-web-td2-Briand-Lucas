describe ("Function Name", function() {
  ...
  /**
   * La fonction est juste définie la première fois, elle est lancée uniquemnt lors de l'expect de h (qu'on a dit = à g) 
   * Sauf que g est devenu 1, et non plus une fonction.  donc erreur.
   */
